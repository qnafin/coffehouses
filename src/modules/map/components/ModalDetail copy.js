...
console.log('FULL_HEIGHT', FULL_HEIGHT, IS_SMALL_DEVICE);


const ItemCoffehouses = ({active, name, address, time_work, image, title, description} ) => {
...
class ModalDetail extends React.Component {
    ...
    render() {
        ...
        if(!item) {
            return (
                <SwipeablePanel
                    ...
                    modalFullHeight={false}
                    heightSmall={290}
                    //heightLarge={!IS_SMALL_DEVICE ? FULL_HEIGHT * 0.05 : null}
        ...
        let {active, name, address, time_work, image, title, description} = item
        ...
        let data = [
            {active, name, address, time_work, image, title, description},
            {active, name, address, time_work, image, title, description}
        ]
        return (
            <SwipeablePanel
                ...
                //heightLarge={!IS_SMALL_DEVICE ? FULL_HEIGHT * 0.05 : null}
            >       
                <View style={{backgroundColor: "red", paddingBottom: 200}}>
                    <FlatList
