...
export default class QRScannerView extends Component {
  ...
  handleAppStateChange = (currentAppState) => {
    if (currentAppState !== 'active') {
      this.rnCamera && typeof this.rnCamera.pausePreview === "function" && this.rnCamera.pausePreview();
    } else {
      this.rnCamera && typeof this.rnCamera.resumePreview === "function" && this.rnCamera.resumePreview();
    }
  };
    ...
    return (
      <RNCamera
        ...
        androidCameraPermissionOptions={{
          ...
          message: 'Необходимо разрешить доступ к камере для сканирования QR кода',
            ...
            return (
              ...
              >
                {status === 'NOT_AUTHORIZED' && (
                  ...
                  >
                    <Text>
                      Вы не разрешили доступ к камере
                    </Text>
                    <View style={{ marginTop: 40 }}>
                      <TouchableOpacity style={styles.qrCodeButton} onPress={this.onCancel}>
                        <Text>
                          Ввести код вручную
                        </Text>
                      </TouchableOpacity>
